...
export const MagneticCursor: FC<MagneticCursorProps> = ({
  ...
  useEffect(() => {
    // One-time browser-capability probe: cannot be computed during SSR/lazy
    // useState init without a hydration mismatch, so this deliberately
    // updates state on mount rather than syncing an external subscription.
